...
#define BDTUN_REQ_WRITE               (1 << 0)
#define BDTUN_REQ_FAILFAST_DEV        (1 << 1)
#define BDTUN_REQ_FAILFAST_TRANSPORT  (1 << 2)
#define BDTUN_REQ_FAILFAST_DRIVER     (1 << 3)
#define BDTUN_REQ_SYNC                (1 << 4)
#define BDTUN_REQ_META                (1 << 5)
#define BDTUN_REQ_PRIO                (1 << 6)
#define BDTUN_REQ_DISCARD             (1 << 7)
#define BDTUN_REQ_NOIDLE              (1 << 8)
...
#define BDTUN_REQ_RAHEAD              (1 << 9)
#define BDTUN_REQ_THROTTLED           (1 << 10)

#define BDTUN_REQ_SORTED              (1 << 11)
#define BDTUN_REQ_SOFTBARRIER         (1 << 12)
#define BDTUN_REQ_FUA                 (1 << 13)
#define BDTUN_REQ_NOMERGE             (1 << 14)
#define BDTUN_REQ_STARTED             (1 << 15)
#define BDTUN_REQ_DONTPREP            (1 << 16)
#define BDTUN_REQ_QUEUED              (1 << 17)
#define BDTUN_REQ_ELVPRIV             (1 << 18)
#define BDTUN_REQ_FAILED              (1 << 29)
#define BDTUN_REQ_QUIET               (1 << 20)
#define BDTUN_REQ_PREEMPT             (1 << 21)
#define BDTUN_REQ_ALLOCED             (1 << 22)
#define BDTUN_REQ_COPY_USER           (1 << 23)
#define BDTUN_REQ_FLUSH               (1 << 24)
#define BDTUN_REQ_FLUSH_SEQ           (1 << 25)
#define BDTUN_REQ_IO_STAT             (1 << 26)
#define BDTUN_REQ_MIXED_MERGE         (1 << 27)
#define BDTUN_REQ_SECURE              (1 << 28)
